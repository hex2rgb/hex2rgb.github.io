(()=>{$(function(){var canvas=document.getElementById("duration-day");canvas.width=$("#duration-day").width();var context=canvas.getContext("2d");var W=canvas.width;var H=canvas.height;var gridX=4;var gridY=4;var colors=Array.from(new Array(12),()=>radomHex());var durVal=0.1;function Particle(x,y){this.x=x;this.y=y;this.color=colors[Math.floor(Math.random()*colors.length)];this.futurRadius=randomInt(1,1.1);this.radius=1.1;this.dying=false;this.base=[x,y];this.drawParticle=function(){if(this.radius<this.futurRadius&&this.dying===false){this.radius+=durVal;}else{this.dying=true;}
